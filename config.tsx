...
export const FILE_PATH_HEADER = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/getHeader"
export const FILE_PATH_MODALS = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/getModals"
export const FILE_PATH_APP = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/loadApp"
export const TEMPLATE_LIST_PATH = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/getTemplateList"
...
export const PATH_POST_UPLOAD_App = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/uploadApp"
export const PATH_POST_MODALS = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/postModals"
export const PATH_POST_IMG_LOCAL = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/postImg"
export const PATH_POST_IMG_MOVE = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/imagMove"
...
export const PATH_POST_IMG = process.env.NEXT_PUBLIC_FRONTEND_URL + "/api/uploadAppImage"
