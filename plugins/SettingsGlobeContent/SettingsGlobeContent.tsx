...
type SettingsGlobeContentProps = {
  open?: any;
  close?: any;
};
const SettingsGlobeContent: React.FC<SettingsGlobeContentProps> = ({
  open,
  close,
}: SettingsGlobeContentProps) => {
      ...
      <DialogContent id="dialog-content-editor">
        <DialogContentText id="alert-dialog-slide-description">
          <div style={{ display: "flex", flexDirection: "column" }}>
            <FontChanger nameSection={LOGO} />
            <Divider className={classes.divider} />
            <FontSizeChanger nameSection={LOGO} />
            <Divider className={classes.divider} />
            <ColorChanger nameSection={LOGO} />
          </div>
        </DialogContentText>
      </DialogContent>
...
export default SettingsGlobeContent;
